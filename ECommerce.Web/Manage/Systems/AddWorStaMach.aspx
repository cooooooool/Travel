<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddWorStaMach.aspx.cs" Inherits="ECommerce.Web.Manage.Systems.AddWorStaMach" %>
        ...
        <div class="form-horizontal">
            <div class="modal-body">
                <div class="control-group">
                    <label class="control-label" for="inputPassword">设备编号：</label>
                    <div class="controls">
                        <input type="text" id="txtName" placeholder="设备编号" runat="server" />
                    </div>
                </div>
            </div>
        </div>
