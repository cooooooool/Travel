<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateFirstNews.aspx.cs" Inherits="ECommerce.Web.Manage.Systems.CreateFirstNews" %>
        ...
        <div class="wraper">
            ...
            <div class="main">
                <div style="line-height: 600px; text-align: center; font-size: 16px;">
                    <a href="/Manage/Systems/ChooseNewsTemplate.aspx?page=<%=Request.QueryString["page"]%>&itid=<%=Request.QueryString["itid"]%>&spid=<%=Request.QueryString["spid"] %>&pid=<%=Request.QueryString["pid"] %>" class="btn btn-default btn-lg">选择资讯模板</a>
                </div>
            </div>
        </div>
    </form>
