<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelInfo.aspx.cs" Inherits="ECommerce.Web.Manage.News.SelInfo" %>
...
<body>
    ...
    <form id="form1" runat="server" style="margin: 0" target="ifrSub">
        ...
        <div class="modal-footer">
            <a onclick="goAddselinfo();" class="btn btn-success">确定</a>
            <button class="btn" data-dismiss="modal" aria-hidden="true">关闭</button>
        </div>
        <script>
            function goAddselinfo() {
