<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAdPic.aspx.cs" Inherits="ECommerce.Web.Manage.News.AddAdPic" %>
...
<body>
    <form id="form1" runat="server" style="margin: 0">
        ...
        <div class="modal-footer">
            <a onclick="goAddapic();" class="btn btn-success">确定</a>
        ...
        <script>
            function goAddapic() {
                ...
                $.ajax({
                    type: 'POST',
                    url: "/Manage/News/Ajax_AddAdPic.aspx?spid=<%=Request.QueryString["spid"]%>&tiid=<%=Request.QueryString["tiid"]%>&itid=<%=Request.QueryString["itid"]%>&sortnum=<%=Request.QueryString["sortnum"]%>&name=" + escape(name) + "&batta=" + escape(batta) + "&iid=<%=Request.QueryString["iid"]%>",
