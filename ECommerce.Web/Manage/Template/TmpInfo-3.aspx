<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TmpInfo-3.aspx.cs" Inherits="ECommerce.Web.Manage.Template.TmpInfo_3" %>
            ...
            <div class="wraper">
                ...
                <div class="main">
                    <div class="row">
                        ...
                        <div class="box col-sm-4 ht2" style="width:400px;margin-right:8px;">
                            <asp:Literal ID="litInfo1" runat="server"></asp:Literal>
                        </div>
                        <div class="box col-sm-8 ht1" style="width:670px;">
