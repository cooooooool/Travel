<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TmpInfo-PicAds.aspx.cs" Inherits="ECommerce.Web.Manage.Template.TmpInfo_PicAds" %>
...
<head runat="server">
    ...
    <script>
        ...
        $(".new-info").live("click", function () {
            window.top.$op = window;
            window.top.$tmp = $(this);
            window.top.$modal = window.top.$.scojs_modal({ remote: '/Manage/News/AddAdPic.aspx?spid=<%=Request.QueryString["spid"]%>&tiid=<%=Request.QueryString["tiid"]%>&ptiid=<%=Request.QueryString["ptiid"]%>&itid=<%=Request.QueryString["itid"]%>&sortnum=' + $(this).attr("data-sortnum") + '&bgw=' + $(this).attr("data-bgw") + '&bgh=' + $(this).attr("data-bgh"), title: '新增纯图广告' });
            window.top.$modal.show();
            return false;
        });
        <%--编辑块内容--%>
        ...
        $(".select-info").live("click", function () {
            window.top.$op = window;
            window.top.$tmp = $(this);
            window.top.$modal = window.top.$.scojs_modal({ remote: '/Manage/Systems/Ajax_TempInfo/SelInfo.aspx?spid=<%=Request.QueryString["spid"]%>&tiid=<%=Request.QueryString["tiid"]%>&ptiid=<%=Request.QueryString["ptiid"]%>&itid=<%=Request.QueryString["itid"]%>&sortnum=' + $(this).attr("data-sortnum"), title: '选择已有内容' });
            window.top.$modal.show();
            return false;
        });
        <%--标记块内容--%>
