<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TmpInfo-PWInfo.aspx.cs" Inherits="ECommerce.Web.Manage.Template.TmpInfoPWInfo" %>
...
<head runat="server">
    ...
    <script>
        ...
        $(".new-info").live("click", function () {
            window.top.$op = window;
            window.top.$tmp = $(this);
            window.top.$modal = window.top.$.scojs_modal({ remote: '/Manage/News/AddPicInfo.aspx?spid=<%=Request.QueryString["spid"]%>&tiid=<%=Request.QueryString["tiid"]%>&pid=<%=Request.QueryString["pid"]%>&itid=<%=Request.QueryString["itid"]%>&sortnum=' + $(this).attr("data-sortnum") + '&bgw=' + $(this).attr("data-bgw") + '&bgh=' + $(this).attr("data-bgh"), title: '新增图文资讯' });
            window.top.$modal.show();
            return false;
        });
        <%--编辑块内容--%>
        $(".edit-info").live("click", function () {
            window.top.$op = window;
            window.top.$tmp = $(this);
            window.top.$modal = window.top.$.scojs_modal({ remote: '/Manage/News/AddPicInfo.aspx?spid=<%=Request.QueryString["spid"]%>&tiid=<%=Request.QueryString["tiid"]%>&pid=<%=Request.QueryString["pid"]%>&itid=<%=Request.QueryString["itid"]%>&sortnum=' + $(this).attr("data-sortnum") + '&bgw=' + $(this).attr("data-bgw") + '&bgh=' + $(this).attr("data-bgh") + '&iid=' + $(this).attr("data-iid"), title: '编辑图文资讯' });
            window.top.$modal.show();
            return false;
        });
        <%--删除块内容--%>
