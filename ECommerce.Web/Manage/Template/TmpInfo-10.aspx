<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TmpInfo-10.aspx.cs" Inherits="ECommerce.Web.Manage.Template.TmpInfo_10" %>
            ...
            <div class="wraper">
                ...
                <div class="main">
                    <div class="row">
                        ...
                        <div class="box col-sm-5 ht2" style="width:400px;margin-right:8px;margin-bottom:8px;">
                            <asp:Literal ID="litInfo1" runat="server"></asp:Literal>
                        </div>
                        <div class="box col-sm-7 ht1" style="width:670px;margin-bottom:8px;">
                            <asp:Literal ID="litInfo2" runat="server"></asp:Literal>
                        </div>
                        <div class="col-sm-7 ht1" style="width:670px;">
                            <div class="box col-sm-6 ht1" style="width:331px;margin-right:8px;">
                                <asp:Literal ID="litInfo3" runat="server"></asp:Literal>
                            </div>
                            <div class="box col-sm-6 ht1" style="width:331px;">
