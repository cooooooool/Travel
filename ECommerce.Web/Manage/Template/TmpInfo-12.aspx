<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TmpInfo-12.aspx.cs" Inherits="ECommerce.Web.Manage.Template.TmpInfo_12" %>
            ...
            <div class="wraper">
                ...
                <div class="main">
                    <div class="row">
                        ...
                        <div class="box col-sm-5 ht2" style="width: 400px; margin-right: 8px;">
                            <asp:Literal ID="litInfo1" runat="server"></asp:Literal>
                        </div>
                        <%--<div class="box col-sm-7 ht2" style="width: 670px;">--%>
                            <div class="box col-sm-10 ht2" style="width: 536px;height:462px; margin-right: 8px;">
                                <asp:Literal ID="litInfo2" runat="server"></asp:Literal>
                            </div>
                            <div class="box col-sm-2 ht2" style="width: 126px; height: 140px; margin-bottom: 8px;">
                            ...
                            <div class="box col-sm-6 ht2" style="width: 331px; height: 136px; margin-right: 8px;">
                                <asp:Literal ID="litInfo5" runat="server"></asp:Literal>
                            </div>
                            <div class="box col-sm-6 ht2" style="width: 331px; height: 136px;">
