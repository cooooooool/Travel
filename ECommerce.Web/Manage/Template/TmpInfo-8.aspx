<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TmpInfo-8.aspx.cs" Inherits="ECommerce.Web.Manage.Template.TmpInfo_8" %>
            ...
            <div class="wraper">
                ...
                <div class="main">
                    <div class="row">
                        ...
                        <div class=" col-sm-7 ht2" style="width:678px;">
                            <div class="box col-sm-12 ht1" style="width:670px;margin-right:8px;margin-bottom:8px;">
                                <asp:Literal ID="litInfo1" runat="server"></asp:Literal>
                            </div>
                            <div class="box col-sm-6 ht1" style="width:331px;margin-right:8px;margin-bottom:8px;">
                        ...
                        <div class="box col-sm-5 ht2" style="width:400px;">
